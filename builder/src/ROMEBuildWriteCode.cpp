   ...
   for (Int_t iTab = 0; iTab < numOfTab; iTab++) {
      ...
      if (tabObjectDisplay[iTab]) {
         for (i=0;i<tabObjectDisplaySupportedObjects.GetEntriesFast();i++) {
            ...
            else if (tabObjectDisplaySupportedObjects.At(i).Contains("1"))
               buffer.AppendFormatted("      ((TObjArray*)fObjects->Last())->AddLast(new %s(str.Data(),\"\",1,0,1));\n",tabObjectDisplaySupportedObjects.At(i).Data());
            else if (tabObjectDisplaySupportedObjects.At(i).Contains("2"))
               buffer.AppendFormatted("      ((TObjArray*)fObjects->Last())->AddLast(new %s(str.Data(),\"\",1,0,1,1,0,1));\n",tabObjectDisplaySupportedObjects.At(i).Data());
            else if (tabObjectDisplaySupportedObjects.At(i).Contains("3"))
         ...
         if (numOfTabObjectDisplays[iTab]>0) {
            for (j=0;j<tabObjectDisplaySupportedObjects.GetEntriesFast();j++) {
               ...
               else if (tabObjectDisplaySupportedObjects.At(j).Contains("2"))
                  buffer.AppendFormatted("      ((TObjArray*)fUserObjects->Last())->AddLast(new %s(str.Data(),\"\",1,0,1,1,0,1));\n",tabObjectDisplaySupportedObjects.At(j).Data());
               else if (tabObjectDisplaySupportedObjects.At(j).Contains("3"))
            ...
            for (j=0;j<tabObjectDisplaySupportedObjects.GetEntriesFast();j++) {
               if (tabObjectDisplaySupportedObjects.At(j)==tabObjectDisplayType[iTab][0])
         ...
         for (i=0;i<numOfTabObjectDisplays[iTab];i++) {
            if (tabObjectDisplayTaskIndex[iTab][i]!=-1) {
               ...
               if (tabObjectDisplayType[iTab][i].Index("TGraph")!=-1) {
                  ...
                  for (j=0;j<tabObjectDisplaySupportedObjects.GetEntriesFast();j++) {
                     if (tabObjectDisplaySupportedObjects.At(j)==tabObjectDisplayType[iTab][i])
                        buffer.AppendFormatted("         *((%s*)((TObjArray*)fUserObjects->At(%d))->At(i)) = *(gAnalyzer->Get%s%sTaskBase()->Get%sAt(i));\n",tabObjectDisplayType[iTab][i].Data(),j,taskHierarchyName[tabObjectDisplayTaskHierarchyIndex[iTab][i]].Data(),taskHierarchySuffix[tabObjectDisplayTaskHierarchyIndex[iTab][i]].Data(),histoName[tabObjectDisplayTaskIndex[iTab][i]][tabObjectDisplayObjectIndex[iTab][i]].Data());
                  }
                  buffer.AppendFormatted("      }\n");
               }
               buffer.AppendFormatted("   }\n");
...
Bool_t ROMEBuilder::AddTaskConfigParameters(ROMEConfigParameterGroup *parGroup,Int_t parentIndex)
{
   ...
   for (i=0;i<numOfTaskHierarchy;i++) {
      ...
      for (j=0;j<numOfGraphs[taskHierarchyClassIndex[i]];j++) {
         ...
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%f\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetXmin());",shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         ...
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%f\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetXmax());",shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         ...
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%f\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetYmin());",shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         ...
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%f\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetYmax());",shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         ...
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%f\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetZmin());",shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         ...
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%f\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetZmax());",shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         subGroup->AddSubGroup(subSubGroup);
      }
      if (numOfSteering[taskHierarchyClassIndex[i]]>0) {
...
Bool_t ROMEBuilder::WriteNetFolderServerCpp() {
   ...
   for (i=0;i<numOfTaskHierarchy;i++) {
      ...
      for (j=0;j<numOfHistos[taskHierarchyClassIndex[i]];j++) {
         ...
         if (histoArraySize[taskHierarchyClassIndex[i]][j]=="1") {
            ...
            buffer.AppendFormatted("   f%s%s_%sHistos[id] = new TObjArray();\n",taskHierarchyName[i].Data(),taskHierarchySuffix[i].Data(),histoName[taskHierarchyClassIndex[i]][j].Data());
         }
      }
      for (j=0;j<numOfGraphs[taskHierarchyClassIndex[i]];j++) {
   ...
   for (i=0;i<numOfTaskHierarchy;i++) {
      ...
      for (j=0;j<numOfHistos[taskHierarchyClassIndex[i]];j++) {
         if (histoArraySize[taskHierarchyClassIndex[i]][j]=="1") {
            buffer.AppendFormatted("   SafeDelete(f%s%s_%sHisto[id]);\n",taskHierarchyName[i].Data(),taskHierarchySuffix[i].Data(),histoName[taskHierarchyClassIndex[i]][j].Data());
         }
         else {
            buffer.AppendFormatted("   SafeDelete(f%s%s_%sHistos[id]);\n",taskHierarchyName[i].Data(),taskHierarchySuffix[i].Data(),histoName[taskHierarchyClassIndex[i]][j].Data());
         }
      }
      for (j=0;j<numOfGraphs[taskHierarchyClassIndex[i]];j++) {
         if (graphArraySize[taskHierarchyClassIndex[i]][j]=="1") {
      ...
      if (!folderSupport[i]) {
         if (numOfValue[i] > 0) {
            if (folderArray[i]=="1") {
               ...
               WriteCheckCommandObject(buffer,"Folder",folderName[i].Data(),"");
               buffer.AppendFormatted("   }\n");
            }
            else {
   ...
   for (i=0;i<numOfTaskHierarchy;i++) {
      ...
      for (j=0;j<numOfHistos[taskHierarchyClassIndex[i]];j++) {
         if (histoArraySize[taskHierarchyClassIndex[i]][j]=="1") {
            ...
            WriteCheckCommandObject(buffer,"Histo",taskHierarchyName[i]+taskHierarchySuffix[i]+"_"+histoName[taskHierarchyClassIndex[i]][j],"");
            buffer.AppendFormatted("   }\n");
         }
         else {
            ...
            WriteCheckCommandObject(buffer,"Histos",taskHierarchyName[i]+taskHierarchySuffix[i]+"_"+histoName[taskHierarchyClassIndex[i]][j],"->At(index)");
            buffer.AppendFormatted("   }\n");
...
Bool_t ROMEBuilder::WriteNetFolderServerH() {
   ...
   for (i=0;i<numOfTaskHierarchy;i++) {
      if (!taskUsed[taskHierarchyClassIndex[i]])
         continue;
      for (j=0;j<numOfHistos[taskHierarchyClassIndex[i]];j++) {
         buffer.AppendFormatted("   Bool_t f%s%s_%sHistoActive[kMaxSocketClients]; // Flag if %s histo is active\n",taskHierarchyName[i].Data(),taskHierarchySuffix[i].Data(),histoName[taskHierarchyClassIndex[i]][j].Data(),histoName[taskHierarchyClassIndex[i]][j].Data());
         if (histoArraySize[taskHierarchyClassIndex[i]][j]=="1") {
            buffer.AppendFormatted("   %s* f%s%s_%sHisto[kMaxSocketClients]; // Handle to %s histo\n",histoType[taskHierarchyClassIndex[i]][j].Data(),taskHierarchyName[i].Data(),taskHierarchySuffix[i].Data(),histoName[taskHierarchyClassIndex[i]][j].Data(),histoName[taskHierarchyClassIndex[i]][j].Data());
         }
         else {
            buffer.AppendFormatted("   TObjArray* f%s%s_%sHistos[kMaxSocketClients]; // Handle to %s histos\n",taskHierarchyName[i].Data(),taskHierarchySuffix[i].Data(),histoName[taskHierarchyClassIndex[i]][j].Data(),histoName[taskHierarchyClassIndex[i]][j].Data());
         }
      }
      for (j=0;j<numOfGraphs[taskHierarchyClassIndex[i]];j++) {
