...
public:
   ...
   virtual bool   Read(ROMEStr2DArray *values,const char *path,int runNumber,int eventNumber) = 0;
   virtual bool   Write(ROMEStr2DArray* values,const char *path,int runNumber,int eventNumber) = 0;
