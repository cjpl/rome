...
// which is better ?
#if 0 // set null pointer
                  buffer.AppendFormatted(",%s(0)\n",valueName[iFold][i].Data());
#else // allocate one object
      ...
      for (i = 0; i < numOfValue[iFold]; i++) {
         ...
         if (valueIsTObject[iFold][i] && !isPointerType(valueType[iFold][i].Data())
            ...
            if (valueDimension[iFold][i] == 0) {
               ...
               buffer.AppendFormatted("   %s->SetName(\"%s%s\");\n",valueName[iFold][i].Data(),shortCut.Data(),
                                      tmp.Data());
      ...
      for (i = 0; i < numOfValue[iFold]; i++) {
         ...
         if (valueDimension[iFold][i] > 0) {
            if (valueType[iFold][i] == "TRef") {
               ...
               buffer.AppendFormatted("   return (%s)(%s->At(indx));\n",valueType[iFold][i].Data(),
                                      valueName[iFold][i].Data());
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
            } else if (isTArrayType(valueType[iFold][i])) {
            ...
            if (valueType[iFold][i] == "TRef") {
               ...
               if (valueType[iFold][i].Contains("*")) {
                  ...
                  buffer.AppendFormatted("   if (%s%sGetSize() < n) Set%sSize(n);\n",valueName[iFold][i].Data(),
                                         relation.Data(),valueName[iFold][i].Data());
               }
      ...
      for (i = 0; i < numOfValue[iFold]; i++) {
         if (valueDimension[iFold][i] > 0) {
            if (isFolder(valueType[iFold][i].Data())) {
               ...
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
               buffer.AppendFormatted("Bool_t %s::%sOutOfBoundsError(const char* where, Int_t i)",clsName.Data(),
                                      valueName[iFold][i].Data());
               buffer.AppendFormatted("{\n");
      ...
      for (i = 0; i < numOfValue[iFold]; i++) {
         if (isFolder(valueType[iFold][i].Data()) && valueDimension[iFold][i] > 0) {
            ...
            format.SetFormatted("   TClonesArray*%%%ds %%s;%%%ds %%s\n",typeLen - 13,
                                nameLen-valueName[iFold][i].Length());
            buffer.AppendFormatted(format.Data(),"",valueName[iFold][i].Data(),"",
      ...
      for (i = 0; i < numOfValue[iFold]; i++) {
         ...
         if (valueDimension[iFold][i] > 0) {
            if (valueType[iFold][i] == "TRef") {
               ...
               format.SetFormatted("   %%-%ds  Get%%sAt(Int_t indx);\n",typeLen);
               buffer.AppendFormatted(format.Data(),valueType[iFold][i].Data(),valueName[iFold][i].Data());
               ...
               // TArray itself checks bounds.
               format.SetFormatted("   %%-%ds  Get%%sAt(Int_t indx)%%%ds { return %%s%%sAt(indx);%%%ds }\n",typeLen,lb,
                                   lb);
               buffer.AppendFormatted(format.Data(),TArray2StandardType(valueType[iFold][i],tempBuffer),
                                      valueName[iFold][i].Data(),"",valueName[iFold][i].Data(),relation.Data(),"");
               if (valueType[iFold][i].Contains("*")) {
                  format.SetFormatted("   %%-%ds  Get%%s()%%%ds { return %%s;%%%ds }\n",typeLen,lb,lb);
                  buffer.AppendFormatted(format.Data(),valueType[iFold][i].Data(),valueName[iFold][i].Data(),"",
                                         valueName[iFold][i].Data(),"");
               ...
               buffer.AppendFormatted(format.Data(),"void",valueName[iFold][i].Data(),
                                      TArray2StandardType(valueType[iFold][i],tempBuffer));
            } else if (valueIsTObject[iFold][i] && !isPointerType(valueType[iFold][i].Data())
                    && !valueType[iFold][i].Contains("TRef") && !valueType[iFold][i].Contains("TString")) {
               format.SetFormatted("   %%-%ds* Get%%sAt(",typeLen);
         ...
         if (valueDimension[iFold][i] == 0) {
            if (valueType[iFold][i] == "TRef") {
               format.SetFormatted("   void Set%%s%%%ds(%%-%ds %%s_value%%%ds) { %%s%%%ds = %%s_value;%%%ds SetModified(true); }\n",
                                   lb,typeLen,lb,lb,lb);
               buffer.AppendFormatted(format.Data(),valueName[iFold][i].Data(),"","TObject*",valueName[iFold][i].Data(),
                                      "",valueName[iFold][i].Data(),"",valueName[iFold][i].Data(),"");
            ...
            if (valueType[iFold][i] == "TRef") {
               ...
               // TArray itself checks bounds.
               format.SetFormatted("   void Set%%sAt%%%ds(Int_t indx,%%-%ds %%s_value%%%ds) { %%s%%sAddAt(%%s_value,indx)%%%ds;%%%ds SetModified(true); }\n",
                                   lb,typeLen,lb,lb,lb);
               buffer.AppendFormatted(format.Data(),valueName[iFold][i].Data(),"",
               ...
               format.SetFormatted("   void Set%%sAt%%%ds(Int_t indx,%%-%ds %%s_value);\n",lb,typeLen);
               buffer.AppendFormatted(format.Data(),valueName[iFold][i].Data(),"",valueType[iFold][i].Data(),
                                      valueName[iFold][i].Data());
         ...
         if (valueDimension[iFold][i] == 0) {
            if (valueType[iFold][i] == "TRef") {
               format.SetFormatted("   void Add%%s%%%ds(%%-%ds %%s_value%%%ds) { %%s%%%ds += %%s_value;%%%ds SetModified(true); }\n",
                                   lb,typeLen,lb,lb,lb);
               buffer.AppendFormatted(format.Data(),valueName[iFold][i].Data(),"","TObject*",
                                      valueName[iFold][i].Data(),"",valueName[iFold][i].Data(),"",
                                      valueName[iFold][i].Data(),"");
            } else {
               if (!isBoolType(valueType[iFold][i].Data())) {
            ...
            if (valueType[iFold][i] == "TRef") {
               ...
               format.SetFormatted("   void Add%%sAt%%%ds(Int_t indx,%%-%ds %%s_value);\n",lb,typeLen);
               buffer.AppendFormatted(format.Data(),valueName[iFold][i].Data(),"",
                                      TArray2StandardType(valueType[iFold][i],tempBuffer),valueName[iFold][i].Data());
            } else if (!isBoolType(valueType[iFold][i].Data())) {
               format.SetFormatted("   void Add%%sAt(");
...
Bool_t ROMEBuilder::WriteBaseTaskCpp()
{
   ...
   for (int iTask = 0; iTask < numOfTask; iTask++) {
      ...
      // Constructor
      if (numOfHistos[iTask] > 0 || numOfGraphs[iTask] > 0) {
         buffer.AppendFormatted("%sT%s_Base::%sT%s_Base(const char *name,const char *title,int level,const char *histoSuffix,TFolder *histoFolder)\n",
      ...
      buffer.AppendFormatted(",histoFolder)\n");
      ...
      if (numOfHistos[iTask] > 0) {
         ...
         for (i = 0; i < numOfHistos[iTask]; i++) {
            ...
            buffer.AppendFormatted("      f%sHisto->SetOriginal(\"%s\",\"%s\",%s,%s,\"%s\",\"%s\",\"%s\",%s,%s,%s,%s,%s,%s,%s,%s,%s);\n",
                                   ...
                                   histoXNbins[iTask][i].Data(),histoXmin[iTask][i].Data(),
                                   histoXmax[iTask][i].Data(),
                                   histoYNbins[iTask][i].Data(),histoYmin[iTask][i].Data(),
                                   histoYmax[iTask][i].Data(),
                                   histoZNbins[iTask][i].Data(),histoZmin[iTask][i].Data(),
      ...
      if (numOfGraphs[iTask] > 0) {
         ...
         for (i = 0; i < numOfGraphs[iTask]; i++) {
            ...
            buffer.AppendFormatted("      f%sGraph->SetOriginal(\"%s\",\"%s\",%s,%s,\"%s\",\"%s\",\"%s\",%s,%s,%s,%s,%s,%s);\n",
                                   graphName[iTask][i].Data(),
               graphTitle[iTask][i].Data(),graphFolderTitle[iTask][i].Data(),graphArraySize[iTask][i].Data(),
                                   graphArrayStartIndex[iTask][i].Data(),
      ...
      if (numOfHistos[iTask] > 0) {
         ...
         for (i = 0; i < numOfHistos[iTask]; i++) {
            if (histoArraySize[iTask][i] == "1") {
               ...
               buffer.AppendFormatted("      return f%s;\n",histoName[iTask][i].Data());
               buffer.AppendFormatted("   }\n");
               buffer.AppendFormatted("   return (%s*)(f%ss->At(indx));\n",histoType[iTask][i].Data(),
                                      histoName[iTask][i].Data());
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
      ...
      if (numOfGraphs[iTask] > 0) {
         ...
         for (i = 0; i < numOfGraphs[iTask]; i++) {
            if (graphArraySize[iTask][i] == "1") {
               ...
               buffer.AppendFormatted("   if (gAnalyzer->IsROMEMonitor())\n");
               buffer.AppendFormatted("      f%s = (%s*)(gAnalyzer->GetSocketClientNetFolder()->FindObjectAny(\"%sT%s:%s\"));\n",
                                      graphName[iTask][i].Data(),graphType[iTask][i].Data(),shortCut.Data(),
                                      taskName[iTask].Data(), graphName[iTask][i].Data());
               buffer.AppendFormatted("   return f%s;\n",graphName[iTask][i].Data());
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
   ...
   for (int iTask = 0; iTask < numOfTask; iTask++) {
      ...
      for (i = 0; i < numOfHistos[iTask]; i++) {
         if (histoArraySize[iTask][i] == "1") {
            ...
            if (histoType[iTask][i][2] == 49) {
               buffer.AppendFormatted("   void Fill%sAt(Int_t /* indx */,Double_t /* x */,Double_t /* weight = 1 */) {\n",
                                      histoName[iTask][i].Data());
               ...
               buffer.AppendFormatted("   void Fill%sAt(Int_t /* indx */,Double_t /* x */,Double_t /* y */,Double_t /* weight = 1 */) {\n",
                                      histoName[iTask][i].Data());
               buffer.AppendFormatted("      ROMEPrint::Error(\"\\nThe method Fill%sAt() was declared deprecated. Use Get%sAt()->Fill().\\nShutting down the program.\\n\");\n",
                                      histoName[iTask][i].Data(),histoName[iTask][i].Data());
               buffer.AppendFormatted("      gROME->GetApplication()->Terminate(1);\n");
               ...
               buffer.AppendFormatted("   void Fill%sAt(Int_t /* indx */,Double_t /* x */,Double_t /* y */,Double_t /* z */,Double_t /* weight = 1 */) {\n",
                                      histoName[iTask][i].Data());
               buffer.AppendFormatted("      ROMEPrint::Error(\"\\nThe method Fill%sAt() was declared deprecated. Use Get%sAt()->Fill().\\nShutting down the program.\\n\");\n",
                                      histoName[iTask][i].Data(),histoName[iTask][i].Data());
               buffer.AppendFormatted("      gROME->GetApplication()->Terminate(1);\n");
            ...
            buffer.AppendFormatted("   void Draw%sAt(Int_t /* indx */) {\n",histoName[iTask][i].Data());
         ...
         for (i = 0; i < tabSingleObjectIndexMax[iTab]; i++) {
            for (j = 0; j < numOfTabSingleObjects[iTab]; j++) {
               if (tabSingleObjectIndex[iTab][j] == i) {
                  ...
                  indx = tabSingleObjectTaskHierarchyIndex[iTab][j];
                  while (indx != -1) {
                     buffer.AppendFormatted(" && gAnalyzer->Get%s%sTaskBase()->IsActive()",
                                            taskHierarchyName[indx].Data(),taskHierarchySuffix[indx].Data());
                     indx = taskHierarchyParentIndex[indx];
                  }
                  indx = tabSingleObjectTaskHierarchyIndex[iTab][j];
                  buffer.AppendFormatted(" && gAnalyzer->Get%s%sTaskBase()->Is%sActive()",
                                         taskHierarchyName[indx].Data(),taskHierarchySuffix[indx].Data(),
                  ...
                  if (tabSingleObjectType[iTab][j] == "Histogram") {
                     if (histoArraySize[tabSingleObjectTaskIndex[iTab][j]][tabSingleObjectObjectIndex[iTab][j]] == "1") {
                        ...
                        buffer.AppendFormatted("      *(f%sSingleObject%d) = *(gAnalyzer->Get%s%sTaskBase()->Get%s());\n",
                                               tabSingleObjectName[iTab][j].Data(),j,
                                               taskHierarchyName[tabSingleObjectTaskHierarchyIndex[iTab][j]].Data(),
                                               taskHierarchySuffix[tabSingleObjectTaskHierarchyIndex[iTab][j]].Data(),
                                               tabSingleObjectName[iTab][j].Data());
                        ...
                        for (k = tabSingleObjectArrayIndexStart[iTab][j]; k <= tabSingleObjectArrayIndexEnd[iTab][j];
                           ...
                           buffer.AppendFormatted("      *(f%sSingleObject%d_%d) = *(gAnalyzer->Get%s%sTaskBase()->Get%sAt(%d));\n",
                                                  ...
                                                  taskHierarchyName[tabSingleObjectTaskHierarchyIndex[iTab][j]].Data(),
                                                  taskHierarchySuffix[tabSingleObjectTaskHierarchyIndex[iTab][j]].Data(),
                                                  tabSingleObjectName[iTab][j].Data(),k);
            ...
            if (tabObjectDisplayTaskIndex[iTab][i] != -1) {
               ...
               if (tabObjectDisplayType[iTab][i].BeginsWith("TG")) {
                  buffer.AppendFormatted(" && gAnalyzer->Get%s%sTaskBase()->Get%sGraph()->IsActive()",
                                         ...
                                         graphName[tabObjectDisplayTaskIndex[iTab][i]][tabObjectDisplayObjectIndex[iTab][i]].Data());
               } else {
                  buffer.AppendFormatted(" && gAnalyzer->Get%s%sTaskBase()->Get%sHisto()->IsActive()",
                                         taskHierarchyName[tabObjectDisplayTaskHierarchyIndex[iTab][i]].Data(),
                                         taskHierarchySuffix[tabObjectDisplayTaskHierarchyIndex[iTab][i]].Data(),
                                         histoName[tabObjectDisplayTaskIndex[iTab][i]][tabObjectDisplayObjectIndex[iTab][i]].Data());
               }
               buffer.AppendFormatted(") {\n");
               if (tabObjectDisplayType[iTab][i].BeginsWith("TG")) {
                  ...
                  if (graphArraySize[tabObjectDisplayTaskIndex[iTab][i]][tabObjectDisplayObjectIndex[iTab][i]] == "1") {
                     buffer.AppendFormatted("         *((%s*)((TObjArray*)fUserObjects->At(%d))->At(i)) = *(gAnalyzer->Get%s%sTaskBase()->Get%s());\n",
                                            tabObjectDisplayType[iTab][i].Data(),
               ...
               if (tabSingleObjectType[iTab][j] == "Histogram") {
                  if (histoArraySize[tabSingleObjectTaskIndex[iTab][j]][tabSingleObjectObjectIndex[iTab][j]] == "1") {
                     ...
                     for (k = tabSingleObjectArrayIndexStart[iTab][j]; k <= tabSingleObjectArrayIndexEnd[iTab][j]; k++) {
                        buffer.AppendFormatted("      *(f%sSingleObject%d_%d) = *(gAnalyzer->Get%s%sTaskBase()->Get%sAt(%d));\n",
                                               tabSingleObjectName[iTab][j].Data(),j,k,taskHierarchyName[tabSingleObjectTaskHierarchyIndex[iTab][j]].Data(),
                                               taskHierarchySuffix[tabSingleObjectTaskHierarchyIndex[iTab][j]].Data(),
                                               tabSingleObjectName[iTab][j].Data(),k);
   ...
   //         buffer.AppendFormatted("   Int_t meid=TThread::SelfId(); // get pthread id\n");
      ...
      for (j = 0; j < numOfTaskHierarchy; j++) {
         if (!taskUsed[taskHierarchyClassIndex[j]])
            continue;
         for (k = 0; k < numOfGraphs[taskHierarchyClassIndex[j]]; k++) {
            if (accessGraph(fileBuffer,taskHierarchyClassIndex[j],k) || accessGraph(buffer,taskHierarchyClassIndex[j],
                                                                                    k)) {
...
Bool_t ROMEBuilder::WriteAnalyzerCpp()
{
   ...
   // Constructor
   buffer.AppendFormatted("%sAnalyzer::%sAnalyzer(ROMERint *app,Bool_t batch,Bool_t daemon,Bool_t nographics)\n",
                          shortCut.Data(),shortCut.Data());
   buffer.AppendFormatted(":ROMEAnalyzer(app,batch,daemon,nographics");
   ...
   for (i = 0; i < numOfFolder; i++) {
      ...
      if (!folderSupport[i]) {
         ...
         buffer.AppendFormatted(format.Data(),folderName[i].Data(),"",parentt.Data(),folderName[i].Data(),
                                folderTitle[i].Data());
      }
   }
   for (i = 0; i < numOfFolder; i++) {
...
//         buffer.AppendFormatted("   fNetFolderRoot[%d]   = \"histos\";\n",i);
   ...
   for (i = 0; i < numOfTaskHierarchy; i++) {
      ...
      if (numOfSteering[taskHierarchyClassIndex[i]] > 0) {
         ...
         steerPointerT.SetFormatted("((%sT%s_Base*)GetTaskObjectAt(%d))->GetSP()",shortCut.Data(),
   ...
   for (i = 0; i < numOfTab; i++) {
      ...
      if (numOfSteering[i+numOfTask + 1] > 0) {
         ...
         ROMEString steerPointerT;
         pointerT.SetFormatted("%s->fSteering", pointer.Data());
         steerPointerT.SetFormatted("((%sT%s_Base*)Get%s%sTab())->GetSP()", shortCut.Data(), tabName[i].Data(),
      ...
      for (j = 0 ;j < numOfHistos[taskHierarchyClassIndex[i]]; j++) {
         if (histoArraySize[taskHierarchyClassIndex[i]][j] == "1") {
            buffer.AppendFormatted("   if (Get%s%sTaskBase()->Get%sHisto()->IsActive() && !Get%s%sTaskBase()->Get%sHisto()->isAccumulation())\n",
                                   ...
                                   histoName[taskHierarchyClassIndex[i]][j].Data(),taskHierarchyName[i].Data(),
      ...
      if (numOfValue[i] > 0) {
         if (folderArray[i] == "1") {
            WriteFillObjectStorageObject(buffer,"f" + folderName[i] + "Folder",
                                         ...
                                         "((" + shortCut + "NetFolderServer*)fNetFolderServer)->Get" + folderName[i] +
...
Bool_t ROMEBuilder::WriteAnalyzer2Cpp()
{
   ...
   for (i = 0; i < numOfTaskHierarchy; i++) {
      ...
      buffer.AppendFormatted("   AddTask(new %sT%s(\"%s%s\",\"%s\",%d,\"%s\",GetHistoFolderAt(%d)));\n",shortCut.Data(),
                             ...
                             taskHierarchyLevel[i],taskHierarchySuffix[i].Data(),i);
...
Bool_t ROMEBuilder::WriteAnalyzerH()
{
   ...
   buffer.AppendFormatted("   void SaveConfigParametersFolder();\n");
...
Bool_t ROMEBuilder::WriteWindowCpp()
{
   ...
   if (numOfTab>0) {
      buffer.AppendFormatted(", new TObjArray(%d)",numOfTab);
   } else {
      buffer.AppendFormatted(", 0");
   }
   buffer.AppendFormatted(")\n");
   for (i = 0; i < numOfTab; i++) {
      ...
      if (tabNumOfChildren[i])
         buffer.AppendFormatted(",f%s%sTabSubTab(0)\n", tabName[i].Data(), tabSuffix[i].Data());
   }
   for (i = 0; i < numOfTab; i++) {
      if (!tabUsed[i])
         continue;
      buffer.AppendFormatted(",f%s%sTabID(0)\n", tabName[i].Data(), tabSuffix[i].Data());
   }
   buffer.AppendFormatted(",fTabSwitches()\n");
   for (i = 0; i < numOfTab; i++) {
      if (!tabUsed[i])
         continue;
      buffer.AppendFormatted(",f%s%sTab(0)\n", tabName[i].Data(), tabSuffix[i].Data());
      buffer.AppendFormatted(",t%sT%s(0)\n", shortCut.Data(), tabName[i].Data());
   }
   buffer.AppendFormatted("{\n");
   for (i = 0; i < numOfTab; i++) {
      if (!tabUsed[i])
   ...
   for (i = 0; i < numOfTab; i++) {
      if (!tabUsed[i])
         continue;
      if (tabNumOfChildren[i])
         buffer.AppendFormatted(",f%s%sTabSubTab(0)", tabName[i].Data(), tabSuffix[i].Data());
   }
   for (i = 0; i < numOfTab; i++) {
      if (!tabUsed[i])
         continue;
   ...
   for (i = 0; i < numOfTab; i++) {
      ...
      if (tabHeredity[i].Length() > 0) {
         if (numOfMenu[tabHeredityIndex[i]] > 0) {
            buffer.AppendFormatted("   for (i = %d; i < %d + %d; i++)\n", numOfMenu[i],numOfMenu[i],
                                   numOfMenu[tabHeredityIndex[i]]);
   ...
   for (i = 0; i < numOfTab; i++) {
      if (!tabUsed[i] || (tabHeredity[i].Length() <= 0 && !tabObjectDisplay[i] && numOfMenu[i] < 0)) {
         continue;
      }
      ...
      if (tabObjectDisplay[i]) {
         ...
         buffer.AppendFormatted("               if (f%sMenu[i]->GetEntry(param1) != 0)\n", tabName[i].Data());
         buffer.AppendFormatted("                  f%s%sTab->BaseMenuClicked(f%sMenu[i],param1);\n", tabName[i].Data(),
                                tabSuffix[i].Data(), tabName[i].Data());
         buffer.AppendFormatted("            }\n");
      }
      buffer.AppendFormatted("         }\n");
   }
   ...
   for (i = 0; i < numOfTab; i++) {
      ...
      buffer.AppendFormatted("         if (fCurrentTabID == f%s%sTabID && param1 != f%s%sTabID) {\n", tabName[i].Data(),
                             tabSuffix[i].Data(), tabName[i].Data(), tabSuffix[i].Data());
   ...
   for (i = 0; i < numOfTab; i++) {
      if (!tabUsed[i] || (tabHeredity[i].Length() <= 0 && numOfMenu[i] <= 0)) {
         continue;
      }
      buffer.AppendFormatted("         // %s\n", tabName[i].Data());
      ...
      Int_t indx = i;
      do {
         buffer.AppendFormatted(" param1 != f%s%sTabID &&", tabName[indx].Data(), tabSuffix[i].Data());
         indx = tabParentIndex[indx];
      } while (indx != -1);
   ...
   for (k = 0; k < numOfMenuItem[i][j]; k++) {
      if (menuItemTitle[i][j][k] == LINE_TITLE) {
         ...
         buffer.AppendFormatted("            f%sMenu[%d]->AddEntry(\"%s\", %s);\n", tabName[iHeredity].Data(),
                                jHeredity, menuItemTitle[i][j][k].Data(),
                                menuItemEnumName[i][j][k].Data());
      }
   }
   ...
   for (i = 0; i < parGroup->GetNumberOfSubGroups(); i++) {
      ...
      if (!(level == 0 && parGroup->GetSubGroupAt(i)->GetGroupName() == "Common") &&
         ...
         if (parGroup->GetSubGroupAt(i)->GetArraySize() == "1") {
            ...
            WriteConfigToFormSubMethods(buffer,parGroup->GetSubGroupAt(i),
                                        tabPointer+parGroup->GetSubGroupAt(i)->GetGroupName().Data()+"/",
            ...
            buffer.AppendFormatted("%s   tempFrame[%d] = tempFrame[%d]->GetSubFrameAt(ii[%d]);\n",sTab.Data(),level + 1,
                                   level,parGroup->GetSubGroupAt(i)->GetHierarchyLevel());
            WriteConfigToFormSubMethods(buffer,parGroup->GetSubGroupAt(i),
                                        tabPointer+parGroup->GetSubGroupAt(i)->GetGroupName().Data()+"/",
                                        newConfigPointer.Data(),level + 1,tab + 1);
            buffer.AppendFormatted("%s}\n",sTab.Data());
   ...
   for (i = 0; i < parGroup->GetNumberOfSubGroups(); i++) {
      if (level == 0 || (level == 1 && parGroup->GetGroupName() == "Common") ||
         ...
         buffer.AppendFormatted("Bool_t %sAnalyzer::Save%s(%sConfigToForm *dialog)\n",shortCut.Data(),
                                parGroup->GetSubGroupAt(i)->GetGroupName().Data(),shortCut.Data());
         buffer.AppendFormatted("{\n");
         buffer.AppendFormatted("   int i,ii[100];\n");
      ...
      if (!(level == 0 && parGroup->GetSubGroupAt(i)->GetGroupName() == "Common") &&
         ...
         if (parGroup->GetSubGroupAt(i)->GetArraySize() == "1") {
            newPointer.SetFormatted("%s%s/",pointer.Data(),parGroup->GetSubGroupAt(i)->GetGroupName().Data());
            WriteConfigToFormSave(buffer,parGroup->GetSubGroupAt(i),newPointer.Data(),
                                  tabPointer+parGroup->GetSubGroupAt(i)->GetGroupName().Data()+"/",
            ...
            buffer.AppendFormatted("%s   for (i = 0; i < ((%sConfig*)gAnalyzer->GetConfiguration())->fConfigData[0]->%sf%sArraySize; i++) {\n",
                                   sTab.Data(),shortCut.Data(),configPointer.Data(),
                                   parGroup->GetSubGroupAt(i)->GetGroupName().Data());
            newPointer.SetFormatted("%s%s/%s",pointer.Data(),parGroup->GetSubGroupAt(i)->GetGroupName().Data(),
                                    parGroup->GetSubGroupAt(i)->GetGroupName().Data());
            WriteConfigToFormSave(buffer,parGroup->GetSubGroupAt(i),newPointer.Data(),
                                  tabPointer+parGroup->GetSubGroupAt(i)->GetGroupName().Data()+"/",
...
Bool_t ROMEBuilder::WriteConfigCpp() {
   ...
   buffer.AppendFormatted(",fXMLFile(\"\")\n");
...
Bool_t ROMEBuilder::WriteConfig2Cpp() {
   ...
   buffer.AppendFormatted("\n// Check Configuration Modified\n");
   buffer.AppendFormatted("Bool_t %sConfig::CheckConfigurationModified(Int_t indx) {\n",shortCut.Data());
   buffer.AppendFormatted("   int i;\n");
   buffer.AppendFormatted("   ROMEString tempPath;\n");
   buffer.AppendFormatted("   %sConfig::ConfigData *configData = fConfigData[indx];\n",shortCut.Data());
   buffer.AppendFormatted("   int ii[100];\n");
...
Bool_t ROMEBuilder::WriteConfig4Cpp() {
   ...
   // Write Configuration
   buffer.AppendFormatted("\n// Write Configuration\n");
   buffer.AppendFormatted("Bool_t %sConfig::WriteConfiguration(ROMEXML *xml,Int_t indx) {\n",shortCut.Data());
   buffer.AppendFormatted("   ROMEString str = \"\";\n");
   buffer.AppendFormatted("   ROMEString writeString;\n");
   buffer.AppendFormatted("   %sConfig::ConfigData *configData = fConfigData[indx];\n",shortCut.Data());
   buffer.AppendFormatted("   int i;\n");
...
Bool_t ROMEBuilder::WriteConfigH() {
   ...
   buffer.AppendFormatted("   Bool_t CheckConfigurationModified(Int_t indx);\n");
   buffer.AppendFormatted("\n");
   buffer.AppendFormatted("protected:\n");
   ...
   buffer.AppendFormatted("   Bool_t WriteConfiguration(ROMEXML *xml,Int_t indx);\n");
   ...
   // Common
   {
      ...
      if (numOfTree>0) {
         ...
         for (i = 0; i < numOfTree; i++) {
            ...
            subsubSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Tree");
            subsubSubGroup->GetLastParameter()->AddSetLine("if (!gAnalyzer->IsROMEMonitor())");
            subsubSubGroup->GetLastParameter()->AddSetLine("   gAnalyzer->GetTreeObjectAt(%d)->SetMaxEntries(((Long_t)##.ToInteger()));",
                                                           i);
            subsubSubGroup->GetLastParameter()->AddWriteLine("if (!gAnalyzer->IsROMEMonitor())");
#if defined( R__VISUAL_CPLUSPLUS )
...
Bool_t ROMEBuilder::AddTaskConfigParameters(ROMEConfigParameterGroup *parGroup,Int_t parentIndex)
{
   ...
   for (i = 0; i < numOfTaskHierarchy; i++) {
      ...
      for (j = 0; j < numOfHistos[taskHierarchyClassIndex[i]]; j++) {
         ...
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetActive(## == \"true\");",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = kFalseTrueString[((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->IsActive()?1:0];",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistTitle"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetTitle(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetTitle();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistFolderTitle"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetFolderTitle(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetFolderTitle();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistArraySize"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetArraySize(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%d\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetArraySize());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistArrayStartIndex"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetArrayStartIndex(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%d\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetArrayStartIndex());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistXLabel"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetXLabel(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetXLabel();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistYLabel"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetYLabel(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetYLabel();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistZLabel"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetZLabel(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetZLabel();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistXNbins"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetXNbins(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%d\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetXNbins());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistXmin"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetXmin(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetXmin());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistXmax"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetXmax(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetXmax());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistYNbins"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetYNbins(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%d\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetYNbins());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistYmin"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetYmin(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetYmin());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistYmax"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetYmax(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetYmax());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistZNbins"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetZNbins(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%d\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetZNbins());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistZmin"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetZmin(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetZmin());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistZmax"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetZmax(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->GetZmax());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("HistAccumulate","1","CheckButton"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Histogram");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->SetAccumulation(## != \"false\");",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     histoName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->AddSetLine(" ");
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = kFalseTrueString[((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sHisto()->isAccumulation()?1:0];",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       histoName[taskHierarchyClassIndex[i]][j].Data());
         subGroup->AddSubGroup(subSubGroup);
      ...
      for (j = 0; j < numOfGraphs[taskHierarchyClassIndex[i]]; j++) {
         ...
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetActive(## == \"true\");",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = kFalseTrueString[((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->IsActive()?1:0];",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphTitle"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetTitle(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetTitle();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphFolderTitle"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetFolderTitle(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetFolderTitle();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphArraySize"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetArraySize(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%d\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetArraySize());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphArrayStartIndex"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetArrayStartIndex(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%d\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetArrayStartIndex());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphXLabel"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetXLabel(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetXLabel();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphYLabel"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetYLabel(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetYLabel();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphZLabel"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetZLabel(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString = ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetZLabel();",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphXmin"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetXmin(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetXmin());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphXmax"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetXmax(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetXmax());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphYmin"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetYmin(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetYmin());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphYmax"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetYmax(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetYmax());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphZmin"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetZmin(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetZmin());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->AddParameter(new ROMEConfigParameter("GraphZmax"));
         subSubGroup->GetLastParameter()->ReadComment(ROMEConfig::kCommentLevelParam, "Graph");
         subSubGroup->GetLastParameter()->AddSetLine("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->SetZmax(##.Data());",
                                                     shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                     taskHierarchyObjectIndex[i],
                                                     graphName[taskHierarchyClassIndex[i]][j].Data());
         subSubGroup->GetLastParameter()->DontWriteLinesAlways();
         subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%g\",((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->Get%sGraph()->GetZmax());",
                                                       shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                                       taskHierarchyObjectIndex[i],
                                                       graphName[taskHierarchyClassIndex[i]][j].Data());
         subGroup->AddSubGroup(subSubGroup);
      ...
      if (numOfSteering[taskHierarchyClassIndex[i]]>0) {
         steerPointerT.SetFormatted("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->GetSP()",shortCut.Data(),
                                    taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i]);
         taskPointerT.SetFormatted("((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))",shortCut.Data(),
                                   taskName[taskHierarchyClassIndex[i]].Data(),taskHierarchyObjectIndex[i]);
...
Bool_t ROMEBuilder::AddTabConfigParameters(ROMEConfigParameterGroup *parGroup,Int_t parentIndex)
{
   ...
   for (i = 0; i < numOfTab; i++) {
      ...
      subGroup->GetLastParameter()->AddSetLine("gAnalyzer->GetWindow()->GetTabSwitches()->%s%s = (## != \"false\");",
                                               tabName[i].Data(),tabSuffix[i].Data());
      subGroup->GetLastParameter()->AddSetLine("gAnalyzer->GetWindow()->Get%s%sTab()->SetTabActive(## != \"false\");",
                                               tabName[i].Data(),tabSuffix[i].Data());
      subGroup->GetLastParameter()->AddWriteLine("writeString = kFalseTrueString[gAnalyzer->GetWindow()->GetTabSwitches()->%s%s?1:0];",
                                                 tabName[i].Data(),tabSuffix[i].Data());
      if (tabObjectDisplay[i]) {
         for (j = 0; j < numOfTabObjectDisplays[i]; j++) {
            subSubGroup = new ROMEConfigParameterGroup(tabObjectDisplayName[i][j],"1","ObjectDisplay",
                                                       "ObjectDisplayName");
            ...
            subSubGroup->GetLastParameter()->AddSetLine("gAnalyzer->GetWindow()->Get%s%sTab()->SetDrawOptionAt(%d,##.Data());",
                                                        tabName[i].Data(),tabSuffix[i].Data(),j);
      ...
      if (numOfTabSingleObjects[i]>0) {
         int nskip = 0;
         int *skip = new int[numOfTabSingleObjects[i]];
         bool skipthis = false;
         int nmulti = 0;
         int *multi = new int[numOfTabSingleObjects[i]];
         for (j = 0; j < numOfTabSingleObjects[i]; j++) {
            ...
            multi[0] = j;
            nmulti = 1;
            for (k = j + 1; k < numOfTabSingleObjects[i]; k++) {
               if (tabSingleObjectName[i][j] == tabSingleObjectName[i][k]) {
                  multi[nmulti] = k;
                  nmulti++;
                  skip[nskip] = k;
                  nskip++;
            ...
            subSubGroup = new ROMEConfigParameterGroup(tabSingleObjectName[i][j],"1","SingleObject","SingleObjectName");
            ...
            for (k = 0; k < nmulti; k++) {
               subSubGroup->GetLastParameter()->AddSetLine("gAnalyzer->GetWindow()->Get%s%sTab()->SetDrawOptionAt(%d,##.Data());",
                                                           tabName[i].Data(),tabSuffix[i].Data(),multi[k]);
               subSubGroup->GetLastParameter()->AddWriteLine("writeString.SetFormatted(\"%%s\",gAnalyzer->GetWindow()->Get%s%sTab()->GetDrawOptionAt(%d));",
                                                             tabName[i].Data(),tabSuffix[i].Data(),multi[k]);
            }
            // Logarithmic scale X
      ...
      parGroup->AddSubGroup(subGroup);
      if (numOfSteering[i+numOfTask + 1]>0) {
         steerPointerT.SetFormatted("gAnalyzer->GetWindow()->Get%s%sTab()->GetSP()", tabName[i].Data(),
                                    tabSuffix[i].Data());
   ...
   for (i = 0; i < numOfSteerFields[numTask][numSteer]; i++) {
      ...
      if (steerFieldArraySize[numTask][numSteer][i] != "1") {
         ...
         if (steerFieldType[numTask][numSteer][i] == "std::string") {
            ...
            subSubGroup->GetLastParameter()->AddSetLine("   %s->Set%sAt(ii[%d],(%s)%s);",steerPointer.Data(),
                                                        steerFieldName[numTask][numSteer][i].Data(),
         ...
         if (steerFieldType[numTask][numSteer][i] == "std::string") {
            ...
            subGroup->GetLastParameter()->AddSetLine("   %s->Set%s((%s)%s);",steerPointer.Data(),
                                                     steerFieldName[numTask][numSteer][i].Data(),
...
Bool_t ROMEBuilder::WriteConfigClass(ROMEString &buffer,ROMEConfigParameterGroup *parGroup,int tab)
{
   ...
   for (i = 0; i < parGroup->GetNumberOfSubGroups() && !found; i++) {
      if (parGroup->GetSubGroupAt(i)->GetArraySize() != "1" &&
          parGroup->GetSubGroupAt(i)->GetArraySize() != "unknown") {
         buffer.AppendFormatted("%s      int i;\n",sTab.Data());
         break;
      }
   }
   ...
   for (i = 0; i < parGroup->GetNumberOfSubGroups(); i++) {
      if (parGroup->GetSubGroupAt(i)->GetArraySize() == "unknown") {
         ...
         buffer.AppendFormatted("%s   %sf%sArraySize = xml->NumberOfOccurrenceOfPath(path+\"/%s%ss/%s\");\n",
                                ...
                                groupName.Data(),parGroup->GetSubGroupAt(i)->GetGroupName().Data(),
                                parGroup->GetSubGroupAt(i)->GetGroupName().Data());
         ...
         buffer.AppendFormatted("%s   %sf%s = new ConfigData::%s%s*[%sf%sArraySize];\n",sTab.Data(),pointer.Data(),
                                parGroup->GetSubGroupAt(i)->GetGroupName().Data(),className.Data(),
                                parGroup->GetSubGroupAt(i)->GetGroupName().Data(),pointer.Data(),
                                parGroup->GetSubGroupAt(i)->GetGroupName().Data());
      ...
      if (parGroup->GetSubGroupAt(i)->GetArraySize() == "unknown") {
         groupNameT.SetFormatted("%s%ss[%d]/%s[%%d]/",groupName.Data(),parGroup->GetSubGroupAt(i)->GetTagName().Data(),
         ...
         if (parGroup->GetSubGroupAt(i)->GetGroupIdentifier().Length()>0) {
            groupNameT.SetFormatted("%s%s[%s='%s'][%s%%d]/",groupName.Data(),
                                    ...
                                    parGroup->GetSubGroupAt(i)->GetTagName().Data(),
                                    parGroup->GetSubGroupAt(i)->GetArrayIdentifier().Data());
         } else {
            groupNameT.SetFormatted("%s%s[%s%%d]/",groupName.Data(),parGroup->GetSubGroupAt(i)->GetTagName().Data(),
                                    parGroup->GetSubGroupAt(i)->GetArrayIdentifier().Data());
         }
         ...
         if (parGroup->GetSubGroupAt(i)->GetGroupIdentifier().Length()>0) {
            ...
            groupNameT.SetFormatted("%s%s[%d]/",groupName.Data(),parGroup->GetSubGroupAt(i)->GetTagName().Data(),
                                    parGroup->GetSubGroupAt(i)->GetMultiplicity());
         }
         if (parGroup->GetSubGroupAt(i)->GetGroupIdentifier() == "Histogram") {
            ...
            for (j = 0; j < parGroup->GetSubGroupAt(i)->GetNumberOfParameters(); j++) {
               if (parGroup->GetSubGroupAt(i)->GetArraySize() == "unknown") {
                  buffer.AppendFormatted("%sf%s[i]->f%sModified",pointer.Data(),
                                         parGroup->GetSubGroupAt(i)->GetGroupName().Data(),
                                         parGroup->GetSubGroupAt(i)->GetParameterAt(j)->GetName());
               } else if (parGroup->GetSubGroupAt(i)->GetArraySize() != "1") {
                  ...
                  buffer.AppendFormatted("tmp%s%d->f%sModified",parGroup->GetSubGroupAt(i)->GetGroupName().Data(),
                                         iSubSave,parGroup->GetSubGroupAt(i)->GetParameterAt(j)->GetName());
               }
               if (j < parGroup->GetSubGroupAt(i)->GetNumberOfParameters() - 1 ||
                   parGroup->GetSubGroupAt(i)->GetNumberOfSubGroups() != 0)
                  buffer.AppendFormatted(" ||\n%s    ",sTabT.Data());
            }
            for (j = 0; j < parGroup->GetSubGroupAt(i)->GetNumberOfSubGroups(); j++) {
               if (parGroup->GetSubGroupAt(i)->GetArraySize() == "unknown") {
                  ...
                  buffer.AppendFormatted("tmp%s%d->f%sModified",parGroup->GetSubGroupAt(i)->GetGroupName().Data(),
                                         iSubSave,parGroup->GetSubGroupAt(i)->GetSubGroupAt(j)->GetGroupName().Data());
               }
                                     ...
                                     ROMEString pointer,Int_t* iSub)
{
   ...
   for (i = 0; i < parGroup->GetNumberOfSubGroups(); i++) {
      ...
      if (parGroup->GetSubGroupAt(i)->GetArraySize() != "1" &&
          parGroup->GetSubGroupAt(i)->GetArrayIdentifier().Length()) {
         if (parGroup->GetSubGroupAt(i)->GetArraySize() == "unknown") {
      ...
      for (j = 0; j < numOfBank[i]; j++) {
         ...
         if (bankArrayDigit[i][j]>0) {
            ...
            if (bankType[i][j] == "structure"||bankType[i][j] == "struct") {
               buffer.AppendFormatted("%sStruct* %sMidasDAQ::Get%sBankAt(Int_t bankIndex,Int_t indx) {\n",
               ...
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
               buffer.AppendFormatted("%sStruct* %sMidasDAQ::GetLast%sBankAt(Int_t bankIndex,Int_t indx) {\n",
                                      bankName[i][j].Data(),shortCut.Data(),bankName[i][j].Data());
               ...
               buffer.AppendFormatted("%s %sMidasDAQ::Get%sBankAt(Int_t bankIndex,Int_t indx) {\n",
               ...
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
               buffer.AppendFormatted("%s %sMidasDAQ::GetLast%sBankAt(Int_t bankIndex,Int_t indx) {\n",
                                      bankType[i][j].Data(),shortCut.Data(),bankName[i][j].Data());
               buffer.AppendFormatted("   if (fLast%sBankExists[bankIndex])\n",bankName[i][j].Data());
               buffer.AppendFormatted("      return *(fLast%sBankPointer[bankIndex] + indx);\n",bankName[i][j].Data());
               buffer.AppendFormatted("   return (%s)exp(999.);\n",bankType[i][j].Data());
            ...
            if (bankType[i][j] == "structure"||bankType[i][j] == "struct") {
               buffer.AppendFormatted("%sStruct* %sMidasDAQ::Get%sBankAt(Int_t indx) {\n",bankName[i][j].Data(),
                                      shortCut.Data(),bankName[i][j].Data());
               ...
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
               buffer.AppendFormatted("%sStruct* %sMidasDAQ::GetLast%sBankAt(Int_t indx) {\n",bankName[i][j].Data(),
                                      shortCut.Data(),bankName[i][j].Data());
               ...
               buffer.AppendFormatted("%s %sMidasDAQ::Get%sBankAt(Int_t indx) {\n",bankType[i][j].Data(),
                                      shortCut.Data(),bankName[i][j].Data());
               buffer.AppendFormatted("   if (f%sBankExists)\n",bankName[i][j].Data());
               buffer.AppendFormatted("      return *(f%sBankPointer + indx);\n",bankName[i][j].Data());
               buffer.AppendFormatted("   return (%s)exp(999.);\n",bankType[i][j].Data());
               ...
               buffer.AppendFormatted("}\n");
               buffer.AppendFormatted("\n");
               buffer.AppendFormatted("%s %sMidasDAQ::GetLast%sBankAt(Int_t indx) {\n",bankType[i][j].Data(),
                                      shortCut.Data(),bankName[i][j].Data());
               buffer.AppendFormatted("   if (fLast%sBankExists)\n",bankName[i][j].Data());
               buffer.AppendFormatted("      return *(fLast%sBankPointer + indx);\n",bankName[i][j].Data());
               buffer.AppendFormatted("   return (%s)exp(999.);\n",bankType[i][j].Data());
...
Bool_t ROMEBuilder::WriteMidasDAQH() {
            ...
            for (k = 0; k < numOfStructFields[i][j]; k++) {
               if (bankFieldArraySize[i][j][k] == "1") {
                  ...
                  if (structFieldSize[i][j][k].Length()>0) {
                     ...
                     buffer.AppendFormatted(format.Data(),structFieldType[i][j][k].Data(),
   ...
   for (i = 0; i < numOfEvent; i++) {
      if (numOfBank[i]>0) {
         for (j = 0; j < numOfBank[i]; j++) {
            if (bankType[i][j] == "structure"||bankType[i][j] == "struct") {
               if (bankTypeLen < (int)bankName[i][j].Length() + 6) {
                  bankTypeLen = bankName[i][j].Length() + 6;
               }
            } else {
               if (bankTypeLen < (int)bankType[i][j].Length()) {
                  bankTypeLen = bankType[i][j].Length();
               }
            }
            if (bankNameLen < (int)bankName[i][j].Length() + bankArrayDigit[i][j]) {
               bankNameLen = bankName[i][j].Length()+bankArrayDigit[i][j];
            }
         }
      }
   }
   ...
   for (i = 0; i < numOfEvent; i++) {
         ...
         if (bankArrayDigit[i][j]>0) {
            if (bankType[i][j] == "structure"||bankType[i][j] == "struct") {
               ...
               buffer.AppendFormatted(format.Data(),bankName[i][j].Data(),"",bankName[i][j].Data(),
                                      bankArraySize[i][j]+bankArrayStart[i][j],"",bankName[i][j].Data());
               ...
               buffer.AppendFormatted(format.Data(),bankType[i][j].Data(),"",bankName[i][j].Data(),
                                      bankArraySize[i][j]+bankArrayStart[i][j],"",bankName[i][j].Data());
            ...
            buffer.AppendFormatted(format.Data(),"",bankName[i][j].Data(),bankArraySize[i][j]+bankArrayStart[i][j],"",
                                   bankName[i][j].Data());
            ...
            format.SetFormatted("   DWORD%%%ds f%%sBankLength;  %%%ds //! Length  of the %%s Bank\n",bankTypeLen-5,
                                bankNameLen-bankName[i][j].Length());
            buffer.AppendFormatted(format.Data(),"",bankName[i][j].Data(),"",bankName[i][j].Data());
      ...
      format.SetFormatted("   Bool_t%%%ds f%%sEventActive;  %%%ds //! Active Flags of the %%s Bank\n",bankTypeLen-6,
                          bankNameLen-eventName[i].Length());
   ...
   for (i = 0; i < numOfEvent; i++) {
      if (numOfBank[i]>0) {
         for (j = 0; j < numOfBank[i]; j++) {
            ...
            if (bankArrayDigit[i][j]>0) {
               if (bankType[i][j] == "structure"||bankType[i][j] == "struct") {
                  buffer.AppendFormatted("   %sStruct* Get%sBankAt(Int_t bankIndex,Int_t indx);\n",
                                         bankName[i][j].Data(),bankName[i][j].Data());
                  buffer.AppendFormatted("   %sStruct* Get%sBankPointer(Int_t bankIndex);\n",bankName[i][j].Data(),
                                         bankName[i][j].Data());
                  buffer.AppendFormatted("   %sStruct* GetLast%sBankAt(Int_t bankIndex,Int_t indx);\n",
                                         bankName[i][j].Data(),bankName[i][j].Data());
                  buffer.AppendFormatted("   %sStruct* GetLast%sBankPointer(Int_t bankIndex);\n",bankName[i][j].Data(),
                                         bankName[i][j].Data());
               } else {
                  buffer.AppendFormatted("   %s  Get%sBankAt(Int_t bankIndex,Int_t indx);\n",bankType[i][j].Data(),
                                         bankName[i][j].Data());
                  buffer.AppendFormatted("   %s* Get%sBankPointer(Int_t bankIndex);\n",bankType[i][j].Data(),
                                         bankName[i][j].Data());
                  buffer.AppendFormatted("   %s  GetLast%sBankAt(Int_t bankIndex,Int_t indx);\n",bankType[i][j].Data(),
                                         bankName[i][j].Data());
               ...
               if (bankType[i][j] == "structure"||bankType[i][j] == "struct") {
                  buffer.AppendFormatted("   %sStruct* Get%sBankAt(Int_t indx);\n",bankName[i][j].Data(),
                                         bankName[i][j].Data());
                  buffer.AppendFormatted("   %sStruct* Get%sBankPointer();\n",bankName[i][j].Data(),
                                         bankName[i][j].Data());
                  buffer.AppendFormatted("   %sStruct* GetLast%sBankAt(Int_t indx);\n",bankName[i][j].Data(),
                                         bankName[i][j].Data());
                  buffer.AppendFormatted("   %sStruct* GetLast%sBankPointer();\n",bankName[i][j].Data(),
                                         bankName[i][j].Data());
               } else {
                  buffer.AppendFormatted("   %s  Get%sBankAt(Int_t indx);\n",bankType[i][j].Data(),
                                         bankName[i][j].Data());
                  buffer.AppendFormatted("   %s* Get%sBankPointer();\n",bankType[i][j].Data(),bankName[i][j].Data());
                  buffer.AppendFormatted("   %s  GetLast%sBankAt(Int_t indx);\n",bankType[i][j].Data(),
                                         bankName[i][j].Data());
...
Bool_t ROMEBuilder::WriteSteeringClass(ROMEString &buffer,Int_t numSteer,Int_t numTask,Int_t tab)
{
   ...
   for (i = 0; i < numOfSteerFields[numTask][numSteer]; i++) {
      if (!steerFieldUsed[numTask][numSteer][i])
         continue;
      if (typeLen < (int)steerFieldType[numTask][numSteer][i].Length()) {
         typeLen = steerFieldType[numTask][numSteer][i].Length();
      }
      if (nameLen < (int)steerFieldName[numTask][numSteer][i].Length()) {
   ...
   for (i = 0; i < numOfSteerChildren[numTask][numSteer]; i++) {
      if (!steerUsed[numTask][steerChildren[numTask][numSteer][i]])
         continue;
      if (typeLen < (int)steerName[numTask][steerChildren[numTask][numSteer][i]].Length() + 1) {
         typeLen = steerName[numTask][steerChildren[numTask][numSteer][i]].Length() + 1;
      }
      if (nameLen < (int)steerName[numTask][steerChildren[numTask][numSteer][i]].Length()) {
   ...
   for (j = 0; j < numOfSteerFields[numTask][numSteer]; j++) {
      ...
      if (steerFieldArraySize[numTask][numSteer][j] == "1") {
         if (steerFieldType[numTask][numSteer][j] == "std::string") {
            ...
            buffer.AppendFormatted("%s   %sf%s((%s)%s)\n",blank.Data(),separator.Data(),
                                   steerFieldName[numTask][numSteer][j].Data(),
   ...
   for (j = 0; j < numOfSteerFields[numTask][numSteer]; j++) {
      ...
      if (steerFieldArraySize[numTask][numSteer][j] == "1") {
         ...
         if (steerFieldType[numTask][numSteer][j] == "std::string") {
            ...
            buffer.AppendFormatted("%s   for (j = 0; j < %s; j++) f%s[j] = (%s)%s;\n",blank.Data(),
                                   steerFieldArraySize[numTask][numSteer][j].Data(),
                                   steerFieldName[numTask][numSteer][j].Data(),
                                   steerFieldType[numTask][numSteer][j].Data(),
                                   steerFieldInit[numTask][numSteer][j].Data());
...
void ROMEBuilder::WriteFolderGetterSource(ROMEString &buffer,Int_t numFolder)
{
   ...
   if (numOfValue[numFolder] > 0) {
      if (folderArray[numFolder] == "1") {
         ...
         buffer.AppendFormatted("   return (%s%s*)f%sFolders->At(indx);\n",shortCut.Data(),folderName[numFolder].Data(),
                                folderName[numFolder].Data());
         buffer.AppendFormatted("}\n");
         buffer.AppendFormatted("\n");
            ...
            for (j = 0; j < numOfSteering[i]; j++) {
               for (k = 0; k < numOfSteerFields[i][j]; k++) {
                  if (steerFieldHotLink[i][j][k]) {
                     GetSteerPath(steerPath,i,j,k,"_");
                     GetSteerPath(steerPointer,i,j,k,"()->Get");
                     buffer.AppendFormatted("      ((%sT%s_Base*)gAnalyzer->GetTaskObjectAt(%d))->GetSP()->Get%s(",
                                            shortCut.Data(),taskName[taskHierarchyClassIndex[i]].Data(),
                                            taskHierarchyObjectIndex[i],steerPointer.Data());
...
//   buffer.AppendFormatted("   gSystem->Load(\"lib%s%s.so\");\n", shortCut.ToLower(tmp), mainProgName.ToLower(tmp2));
   ...
   for (iFold = 0; iFold < numOfFolder; iFold++) {
      ...
      if (folderArray[iFold] == "1") {
         ...
         buffer.AppendFormatted(format.Data(), shortCut.Data(), folderName[iFold].Data(), "", folderName[iFold].Data(),
                                shortCut.Data(), folderName[iFold].Data());
      } else {
         ...
         if (folderArray[iFold] == "1") {
            for (iValue = 0; iValue < numOfValue[iFold]; iValue++) {
               if (isFolder(valueType[iFold][iValue].Data())) {
                  ...
                  if (valueDimension[iFold][iValue] > 0 ) {
                     buffer.AppendFormatted("//       cout<<\"   //%s/%s/%s\\t\"<<%s->Get%sAt(",treeName[iTree].Data(),
                                            branchName[iTree][iBranch].Data(), valueName[iFold][iValue].Data(),
            ...
            for (iValue = 0; iValue < numOfValue[iFold]; iValue++) {
               if (isFolder(valueType[iFold][iValue].Data())) {
                  ...
                  if (valueDimension[iFold][iValue] > 0 ) {
                     buffer.AppendFormatted("//          cout<<\"   //%s/%s/%s\\t\"<<((%s%s*) %s->At(0))->Get%sAt(",
                                            treeName[iTree].Data(), branchName[iTree][iBranch].Data(),
