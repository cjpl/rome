...
*/
   ...
   for (i=0;i<numOfTaskHierarchy;i++) {
      if (!taskUsed[taskHierarchyClassIndex[i]])
         continue;
      buffer.AppendFormatted("bool %sAnalyzer::Is%s%sActive() {\n",shortCut.Data(),taskHierarchyName[i].Data(),taskHierarchySuffix[i].Data());
