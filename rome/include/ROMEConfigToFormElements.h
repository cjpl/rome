// $Id: ROMEConfigToForm.h 1041 2006-05-04 18:20:33Z sawada $
#ifndef ROMEConfigToFormElements_H
#define ROMEConfigToFormElements_H

#include "ROMEStr2DArray.h"
#include <TArrayI.h>

class ROMEConfigToFormElements : public TObject
{
private:
   ROMEStrArray fType;
   ROMEStrArray fTitle;
...
public:
   ...
   ClassDef(ROMEConfigToFormElements, 0) // Element in ROMEConfigToForm
};

#endif   // ROMEConfigToFormElements_H
