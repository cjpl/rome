...
void ArgusHistoDisplay::BaseTabSelected()
{
   ...
   fMenuViewDevide = new TGPopupMenu(fClient->GetRoot());
   fMenuViewDevide->Associate(gROME->GetWindow());
   ...
   fMenuViewDevide->AddEntry("1x1", M_ARGUS_DISPLAY_VIEW_1_1);
   fMenuViewDevide->AddEntry("1x2", M_ARGUS_DISPLAY_VIEW_1_2);
   fMenuViewDevide->AddEntry("2x2", M_ARGUS_DISPLAY_VIEW_2_2);
   fMenuViewDevide->AddEntry("3x2", M_ARGUS_DISPLAY_VIEW_3_2);
   fMenuViewDevide->AddEntry("4x2", M_ARGUS_DISPLAY_VIEW_4_2);
   fMenuViewDevide->AddEntry("5x2", M_ARGUS_DISPLAY_VIEW_5_2);
   fMenuViewDevide->AddEntry("6x2", M_ARGUS_DISPLAY_VIEW_6_2);
   fMenuViewDevide->AddEntry("7x2", M_ARGUS_DISPLAY_VIEW_7_2);
   fMenuViewDevide->AddEntry("8x2", M_ARGUS_DISPLAY_VIEW_8_2);
   fMenuViewDevide->AddEntry("9x2", M_ARGUS_DISPLAY_VIEW_9_2);
   fMenuViewDevide->AddEntry("10x2", M_ARGUS_DISPLAY_VIEW_10_2);
   fMenuViewDevide->AddEntry("1x3", M_ARGUS_DISPLAY_VIEW_1_3);
   fMenuViewDevide->AddEntry("2x3", M_ARGUS_DISPLAY_VIEW_2_3);
   fMenuViewDevide->AddEntry("3x3", M_ARGUS_DISPLAY_VIEW_3_3);
   fMenuViewDevide->AddEntry("4x3", M_ARGUS_DISPLAY_VIEW_4_3);
   fMenuViewDevide->AddEntry("5x3", M_ARGUS_DISPLAY_VIEW_5_3);
   fMenuView->AddPopup("Devide", fMenuViewDevide);
   for (i=0;i<20;i++) {
...
void ArgusHistoDisplay::BaseTabUnSelected()
{
   ...
   delete gROME->GetWindow()->GetMenuBar()->RemovePopup("Devide");
