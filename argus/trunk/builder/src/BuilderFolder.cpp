/********************************************************************
  ...
  $Log$
  Revision 1.15  2005/05/14 21:42:22  sawada
...
Bool_t ArgusBuilder::WriteFolderCpp() {
   ...
   for (Int_t iFold=0;iFold<numOfFolder;iFold++) {
      ...
      header.AppendFormatted((Char_t*)format.Data(),shortCut.Data(),folderName[iFold].Data());
      header.AppendFormatted("//                                                                            //\n");
      ...
      header.AppendFormatted("//                                                                            //\n");
      header.AppendFormatted("//                                                                            //\n");
      header.AppendFormatted("// This file has been generated by the ArgusBuilder.                           //\n");
      header.AppendFormatted("//                                                                            //\n");
      header.AppendFormatted("/////////////////////////////////////----///////////////////////////////////////");
      // Write File
