...
void HWTEnglish::Init()
{
   ...
   fVert = new TGVerticalFrame(fParent, (UInt_t) (700 * gAnalyzer->GetWindowScale()), (UInt_t) (700 * gAnalyzer->GetWindowScale()));

   // Create an embedded canvas and add to the main frame, centered in x and y 
   fCanvas = new TRootEmbeddedCanvas("Hello World", fVert, (UInt_t) (600 * gAnalyzer->GetWindowScale()), (UInt_t) (600 * gAnalyzer->GetWindowScale()));
